...
data modify storage schwer:svm_store WorkingSecondary append from storage schwer:svm_store WorkingSecondary[0]
data remove storage schwer:svm_store WorkingSecondary[0]
